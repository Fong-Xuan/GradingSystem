...
public class Grades {
	...
	* Example: 
	...
	/* method  loadGradeFile ----------------------------------------------------------------------------------                                                                                                    
	* load all the infomation
	*
	* @param none
	* @return none
	*
	*Pseudo code:
	*1.load the information from gradeinput.txt
	*2.parse the information and save it
    *
	* Time estimate : 
	* Example: 
	----------------------------------------------------------------------------------------------------------*/
...
//						tmp.get(2), tmp.get(3), tmp.get(4), tmp.get(5)));
	...
	*
	*Pseudo code:
	*1.call calculateAverage(),resetAllTotalGrades();,sortGrades(),setRank()
    *
	* Time estimate : 
	* Example: 
	----------------------------------------------------------------------------------------------------------*/
	...
	*
	*Pseudo code:
	*1.use the info in gradeList to recalculate the avg scores
    *
	* Time estimate : 
	* Example: 
	----------------------------------------------------------------------------------------------------------*/
